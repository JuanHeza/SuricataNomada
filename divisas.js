...
module.exports = {
    ...
    ${this.getBandera("JPY")} *Yen Japonés*`
                ...
                respuesta: "Se pueden comprar hasta 4,000 usd o su equivalente en divisas  al mes por persona presentando su identificacion oficial vigente, dicha cantidad la puede cambiar en una sola operacion odurante varias dentro del mes.\nEn cuanto a la venta, se le pueden vender hasta  4.900  usd en ventanilla o su equivalente en divisas, si desea una cantidad mayor puede proporcionar sus datos y un promotor se pondra en contacto con usted (se le pondria la opcion para enlazarlos al whatsapp de contact center)"
